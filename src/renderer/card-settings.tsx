  ...
  public renderFloppy() {
    ...
    return (
      <fieldset>
        ...
        />
        <p>
          windows98 comes with a virtual floppy drive. It can mount floppy disk
        ...
        <p>
          ...
          windows98 machine from scratch.
        </p>
        <p id="floppy-path">
          {floppy
  ...
  public renderState() {
    ...
    return (
      <fieldset>
        ...
        <div>
          <p>
            windows98 stores changes to your machine (like saved files) in a
            state file. If you encounter any trouble, you can reset your state
            or boot Windows 98 from scratch.{' '}
